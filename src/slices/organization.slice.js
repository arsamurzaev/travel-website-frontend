...
export const addOrganization = createAsyncThunk(
    ...
    async ({login, password, requisites, contacts, image }, thunkAPI) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:4000/organization',{
            method: 'POST',
            body: formData
        })
...
export const getOrganization = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
        try {
            const responseGet = await fetch('http://localhost:4000/organization')
...
export const deleteOrganization = createAsyncThunk(
    ...
    async (_id, thunkAPI) => {
        try {
            const responseDelete = await fetch(`http://localhost:4000/organization${_id}`, {
                method: 'DELETE',
                headers: {
