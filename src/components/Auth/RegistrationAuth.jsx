...
const Registration = () => {
    ...
    const [authReg, setAuthReg] = useState('Регистрация')
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.container}>
                <div className={styles.reg_card}>
                    ...
                    <h1 className={styles.h1}>{authReg === "Авторизация" ? 'Авторизация' : 'Регистрация'}</h1>

                    <div className={styles.auth_reg_flex}>
                        <div className={styles.auth_reg}>
                            <div className={authReg === "Авторизация" ? styles.selected : styles.not_selected} onClick={() => setAuthReg('Авторизация')}>Авторизация</div>
                            <div className={authReg === "Регистрация" ? styles.selected : styles.not_selected} onClick={() => setAuthReg('Регистрация')}>Регистрация</div>
                    ...
                    <div className={styles.center}>
                        ...
                        {authReg === "Авторизация" ? <AuthComponent  /> : <RegComponent setAuthReg = {setAuthReg}/>}
